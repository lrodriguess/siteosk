...
<div id="main">
  ...
  <div id="content">
    ...
    <div id="content_its" class="it_cont it_t_263">
      <div id="content_its_sld"><a href="oskarmetsavahtprofile.php"><img src="uploads/oskar/perfil.jpg" width="263" height="350" /></a></div>
      <div id="content_its_txt">
        <h2><a href="oskarmetsavahtprofile.php">Oskar Metsavaht Profile</a></h2>
        [ clique para ler o perfil completo ]
      </div>
    </div>
    <!-- -->
    <!-- -->
