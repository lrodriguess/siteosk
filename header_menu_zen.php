    ...
    <div id="header_content">
      ...
      <div id="menu">
        <ul>
          ...
          <?php if ($lang == "en") { ?>
 	           <li><a href="/inhotim_en.php" title="Inhotim">Inhotim</a></li>
               <li><a href="/colecoes_en.php" title="previous collections">previous collections</a></li>
               <!--
		  ...
		  <?php } elseif ($lang == "jp") { ?>
              ...
              <li><a href="http://www.hpfrance.com/Blog/osklen/" target="_blank" title="Blog">ブログ</a></li>
 	          ...
 	          <li><a href="/intothemountains_jp.php" title="Into the mountains">Into The Mountains</a></li>
              -->
              <li><a href="/lojas_jp.php" title="Stores">店舗</a></li>
              <li><a href="/oskarmetsavaht_jp.php" title="Oskar Metsavaht">オスカル・メツァヴァト</a></li>
              <!--<li><a href="https://ja-jp.facebook.com/osklen.japan" target="_blank" title="facebook">facebook</a></li> -->
             <li><a href="http://www.institutoe.org.br/en/" target="_blank" title="e-fabric">イー・ファブリック</a></li>
              <li><a href="/contato_jp.php" title="Contact">お問い合わせ</a></li>
              <li class="cat-store"><a href="http://www.hpfmall.com/shop/hpfmall/item/list/category_id/3031" target="_blank" title="Shop Online"><span>ウェブ ショップ</span></a></li>              
          <?php } else { ?>
             <li><a href="/fw15.php" title="F/W 15">F/W 15</a></li>
               <li><a href="/colecoes.php" title="coleções anteriores">coleções anteriores</a></li>
               <!--
