    ...
    <div id="content"> 
      <!-- TIMELINE -->
        ...
        <ul>
            ...
            <li id="2015"><a title="em breve" onclick="irPara('.2015')"><img src="images/2015.jpg" /></a></li>
        </ul>
