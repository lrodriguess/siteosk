    ...
    <div id="content"> 
      ...
      <div id="content_block" class="historia"> 
        ...
        <div id="content_block" class="i2005titulo">
          <h2>2005</h2>
          <h3>A CRIAÇÃO</h3>
          <p>O Riva é um clássico da Osklen. Lançado em 2006, a marca desejava levar para os pés o lifestyle Osklen, com um tênis despojado e esporte, que caminhasse pelas pedras do Arpoador e pelo asfalto. Seu modelo inovador elevou o status dos tênis, antes pensados somente para a prática de esportes. Desde então, o Riva ganhou inúmeras versões e é um dos modelos da Osklen mais recriados em edições especiais, resultado das constantes pesquisas de material realizadas pela marca.</p>
        </div>
        <!-- FIM TITULO -->
        ...
        <div id="content_block">
          <div id="hist_det_left">
            ...
            <p>Além do design inédito, o Riva foi lançado já com as características que o eternizaram, como o trio de ilhoses aplicados na parte frontal do tênis. Outros detalhes como o talão destacado, o cabedal com as faixas laterais e o solado personalizado com a linha dupla colorida também aparecem desde o primeiro modelo. A palmilha e o forro foram produzidos em couro a fim de oferecer mais conforto aos pés e estabilidade ao caminhar. </p>
          </div>
