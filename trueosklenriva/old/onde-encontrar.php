  ...
  <div id="principal">
    <div id="header">
      ...
      <div id="top" class="topo-interno">
        ...
        <div id="top-int">
          <h2>onde encontrar <span>originais</span></h2>
          <p>A Osklen está atenta a questão da pirataria e utiliza todas as ferramentas disponíveis para combater esse mercado criminoso. Para auxiliar você a não ser vítima desses mal-feitores, estão disponíveis abaixo os pontos de venda oficiais Osklen, incluindo as lojas físicas da marca e revendedores autorizados. Na internet, o único site que oferece produtos originais é a loja online oficial Osklen, que você acessa em <strong><a href="http://store.osklen.com" title="Osklen Store" target="_blank">store.osklen.com</a></strong>.</p>
          <ul>
            <li><a title="manifesto" onclick="abrir('#manifesto')">manifesto</a></li>
    ...
    <div id="seta-top" class="interno setaTop">
      ...
      <h2>manifesto</h2>
      <p>Lançado em 2006, o Riva apresentou uma nova proposta de tênis entre os modelos exclusivamente esportivos da época. Foi idealizado por Oskar Metsavaht como um calçado para andar do asfalto às pedras do Arpoador. Não à toa, o Riva se tornou o tênis mais conhecido da Osklen e até hoje, a cada coleção, ele ganha novas versões, com diferentes estampas, cores e materiais.</p>
      <p>Marca admirada no Brasil e no exterior por seu design e sua história, a Osklen é vítima constante de falsificadores que tentam se aproveitar do valor que construímos e mantivemos ao longo de mais de 20 anos. Sendo um dos itens icônicos da marca, o Riva é a peça mais imitada, replicada e pirateada de nossas coleções.</p>
      <p>Estamos em combate diário para proteger nossos produtos, vendas e principalmente nossos clientes deste comércio criminoso, com pesado investimento em múltiplas ações de combate. </p>
      <p>VOCÊ TAMBÉM PODE EVITAR SER VÍTIMA DESSE COMÉRCIO ANTIÉTICO E ILEGAL.</p>
      <p>Os tênis Riva e todos os outros modelos da Osklen só podem ser encontrados nas mais de 70 lojas da marca no Brasil e no exterior, ou nas lojas multimarcas autorizadas (confira a lista abaixo).</p>
      <p>A venda online é exclusiva* da nossa loja oficial (<a href="http://store.osklen.com">store.osklen.com</a>). NENHUM perfil de Facebook ou Instagram vende produtos originais. NENHUMA página do Mercado Livre, OLX ou outros afins, que disponibilizam vários modelos em diversos tamanhos, vende produtos originais. </p>
    ...
    <div id="seta-top" class="interno setaTop">
      ...
      <div id="multi_coluna">
        ...
        <p><strong>PARAÍBA<br>
          </strong> CAMPINA GRANDE - GUERRIER<br>
