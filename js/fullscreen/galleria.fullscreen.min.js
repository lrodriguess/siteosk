...
this.addIdleState(f,{opacity:0});this.addIdleState(this.get("info"),{opacity:0});Galleria.IE&&this.addIdleState(this.get("iefix"),{opacity:1});this.$("image-nav-left, image-nav-right").css("opacity",1).hover(function(){b(this).animate({opacity:1},100)},function(){b(this).animate({opacity:1})}).show();if(e._hideDock)d.click(this.proxy(function(){d.toggleClass("open",!c);if(c){f.animate({top:g},400,e.easing);j.animate({bottom:20},400,e.easing);}else{f.animate({top:g-h.outerHeight()+2},400,e.easing);j.animate({bottom:70},400,e.easing);};c=!c}));else{this.bind("thumbnail",function(){f.css("top", g-h.outerHeight()+2)});d.css("visibility","hidden")}this.$("thumbnails").children().hover(function(){b(this).not(".active").children().stop().fadeTo(100,1)},function(){b(this).not(".active").children().stop().fadeTo(400,0.6)});this.enterFullscreen();this.attachKeyboard({escape:function(){return false},up:function(a){c||d.click();a.preventDefault()},down:function(a){c&&d.click();a.preventDefault()}})}})})(jQuery);